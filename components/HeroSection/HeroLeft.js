    ...
    <>
      <div className="md:w-3/5  pb-10 lg:py-14 xl:py-14">
        ...
        <h2 className="md:w-8/12 py-4 text-center md:text-left md:py-8 text-dark text-lg lg:text-2xl">
            Experienced Frontend Web Developer and Applications Developer with a demonstrated history of working in the Development industry. Skilled in React Js, React Native, Firebase, Node Js.
        </h2>
